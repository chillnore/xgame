...
/**
 * Allocates {@link MsgBuffer}s and manages them.  Please implement this
 * interface if you need more advanced memory management scheme.
 *
 * @author <a href="http://mina.apache.org">Apache MINA Project</a>
 */
public interface MsgBufferAllocator {
    /**
     ...
     */
    MsgBuffer allocate(int capacity, boolean direct);
     ...
     */
    MsgBuffer wrap(ByteBuffer nioBuffer);
