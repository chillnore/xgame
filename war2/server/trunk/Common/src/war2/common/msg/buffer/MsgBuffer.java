 ...
 *
 */
package war2.common.msg.buffer;
 ...
 * easy, and it is because its size is fixed. {@link MsgBuffer} introduces
 ...
 * </pre>
 * 
 * The underlying {@link ByteBuffer} is reallocated by {@link MsgBuffer} behind
 ...
 * allocated memory area is not being used. {@link MsgBuffer} provides
 * <tt>autoShrink</tt> property to take care of this issue. If
 * <tt>autoShrink</tt> is turned on, {@link MsgBuffer} halves the capacity of the
 ...
 * <p>
 * {@link MsgBufferAllocator} interface lets you override the default buffer
 ...
 * {@link #setAllocator(MsgBufferAllocator)}.
 * </p>
 * 
 * @author <a href="http://mina.apache.org">Apache MINA Project</a>
 */
public abstract class MsgBuffer implements Comparable<MsgBuffer> {
    /** The allocator used to create new buffers */
    private static MsgBufferAllocator allocator = new SimpleBufferAllocator();
     ...
     */
    public static MsgBufferAllocator getAllocator() {
        return allocator;
    }
     ...
     */
    public static void setAllocator(MsgBufferAllocator newAllocator) {
        if (newAllocator == null) {
            throw new IllegalArgumentException("allocator");
        }

        MsgBufferAllocator oldAllocator = allocator;
    ...
    public static void setUseDirectBuffer(boolean useDirectBuffer) {
        MsgBuffer.useDirectBuffer = useDirectBuffer;
    }
     ...
     */
    public static MsgBuffer allocate(int capacity) {
     ...
     *            heap buffer.
     */
    public static MsgBuffer allocate(int capacity, boolean direct) {
        if (capacity < 0) {
     ...
     */
    public static MsgBuffer wrap(ByteBuffer nioBuffer) {
     ...
     */
    public static MsgBuffer wrap(byte[] byteArray) {
     ...
     * Wraps the specified byte array into MINA heap buffer.
     */
    public static MsgBuffer wrap(byte[] byteArray, int offset, int length) {
     ...
     * that it can be reused by some {@link MsgBufferAllocator} implementations.
     ...
     * the buffer.
     */
    public abstract MsgBuffer minimumCapacity(int minimumCapacity);
     ...
     * the buffer.
     */
    public abstract MsgBuffer capacity(int newCapacity);
     ...
     */
    public abstract MsgBuffer setAutoExpand(boolean autoExpand);
     ...
     */
    public abstract MsgBuffer setAutoShrink(boolean autoShrink);
     ...
     */
    public abstract MsgBuffer expand(int expectedRemaining);
     ...
     */
    public abstract MsgBuffer expand(int position, int expectedRemaining);
     ...
     */
    public abstract MsgBuffer shrink();
     ...
     */
    public abstract MsgBuffer position(int newPosition);
     ...
     */
    public abstract MsgBuffer limit(int newLimit);

    /**
     * @see java.nio.Buffer#mark()
     */
    public abstract MsgBuffer mark();
     ...
     */
    public abstract MsgBuffer reset();

    /**
     * @see java.nio.Buffer#clear()
     */
    public abstract MsgBuffer clear();
     ...
     * discarded.
     */
    public abstract MsgBuffer sweep();
     ...
     * is discarded.
     */
    public abstract MsgBuffer sweep(byte value);

    /**
     * @see java.nio.Buffer#flip()
     */
    public abstract MsgBuffer flip();

    /**
     * @see java.nio.Buffer#rewind()
     */
    public abstract MsgBuffer rewind();
     ...
     */
    public abstract MsgBuffer duplicate();

    /**
     * @see ByteBuffer#slice()
     */
    public abstract MsgBuffer slice();

    /**
     * @see ByteBuffer#asReadOnlyBuffer()
     */
    public abstract MsgBuffer asReadOnlyBuffer();
     ...
     */
    public abstract MsgBuffer put(byte b);
     ...
     */
    public abstract MsgBuffer put(int index, byte b);

    /**
     * @see ByteBuffer#get(byte[], int, int)
     */
    public abstract MsgBuffer get(byte[] dst, int offset, int length);

    /**
     * @see ByteBuffer#get(byte[])
     */
    public abstract MsgBuffer get(byte[] dst);

    /**
     * TODO document me.
     */
    public abstract MsgBuffer getSlice(int index, int length);

    /**
     * TODO document me.
     */
    public abstract MsgBuffer getSlice(int length);

    /**
     * Writes the content of the specified <tt>src</tt> into this buffer.
     */
    public abstract MsgBuffer put(ByteBuffer src);

    /**
     * Writes the content of the specified <tt>src</tt> into this buffer.
     */
    public abstract MsgBuffer put(MsgBuffer src);

    /**
     * @see ByteBuffer#put(byte[], int, int)
     */
    public abstract MsgBuffer put(byte[] src, int offset, int length);

    /**
     * @see ByteBuffer#put(byte[])
     */
    public abstract MsgBuffer put(byte[] src);

    /**
     * @see ByteBuffer#compact()
     */
    public abstract MsgBuffer compact();
     ...
     */
    public abstract MsgBuffer order(ByteOrder bo);
     ...
     */
    public abstract MsgBuffer putChar(char value);
     ...
     */
    public abstract MsgBuffer putChar(int index, char value);
     ...
     */
    public abstract MsgBuffer putShort(short value);
     ...
     */
    public abstract MsgBuffer putShort(int index, short value);
     ...
     */
    public abstract MsgBuffer putMediumInt(int value);
     ...
     *             If this buffer is read-only
     */
    public abstract MsgBuffer putMediumInt(int index, int value);

    /**
     * @see ByteBuffer#putInt(int)
     */
    public abstract MsgBuffer putInt(int value);
    
    /**
     * Writes an unsigned byte into the ByteBuffer
     * @param value the byte to write
     */
    public abstract MsgBuffer putUnsigned(byte value);
     ...
     * @param value the byte to write
     */
    public abstract MsgBuffer putUnsigned(int index, byte value);
    
    /**
     * Writes an unsigned byte into the ByteBuffer
     * @param value the short to write
     */
    public abstract MsgBuffer putUnsigned(short value);
     ...
     * @param value the short to write
     */
    public abstract MsgBuffer putUnsigned(int index, short value);
    
    /**
     * Writes an unsigned byte into the ByteBuffer
     * @param value the int to write
     */
    public abstract MsgBuffer putUnsigned(int value);
     ...
     * @param value the int to write
     */
    public abstract MsgBuffer putUnsigned(int index, int value);
    
    /**
     * Writes an unsigned byte into the ByteBuffer
     * @param value the long to write
     */
    public abstract MsgBuffer putUnsigned(long value);
     ...
     * @param value the long to write
     */
    public abstract MsgBuffer putUnsigned(int index, long value);
    
    /**
     * Writes an unsigned int into the ByteBuffer
     * @param value the byte to write
     */
    public abstract MsgBuffer putUnsignedInt(byte value);
     ...
     * @param value the byte to write
     */
    public abstract MsgBuffer putUnsignedInt(int index, byte value);
    
    /**
     * Writes an unsigned int into the ByteBuffer
     * @param value the short to write
     */
    public abstract MsgBuffer putUnsignedInt(short value);
     ...
     * @param value the short to write
     */
    public abstract MsgBuffer putUnsignedInt(int index, short value);
    
    /**
     * Writes an unsigned int into the ByteBuffer
     * @param value the int to write
     */
    public abstract MsgBuffer putUnsignedInt(int value);
     ...
     * @param value the int to write
     */
    public abstract MsgBuffer putUnsignedInt(int index, int value);
    
    /**
     * Writes an unsigned int into the ByteBuffer
     * @param value the long to write
     */
    public abstract MsgBuffer putUnsignedInt(long value);
     ...
     * @param value the long to write
     */
    public abstract MsgBuffer putUnsignedInt(int index, long value);
    
    /**
     * Writes an unsigned short into the ByteBuffer
     * @param value the byte to write
     */
    public abstract MsgBuffer putUnsignedShort(byte value);
     ...
     * @param value the byte to write
     */
    public abstract MsgBuffer putUnsignedShort(int index, byte value);
    
    /**
     * Writes an unsigned Short into the ByteBuffer
     * @param value the short to write
     */
    public abstract MsgBuffer putUnsignedShort(short value);
     ...
     * @param value the short to write
     */
    public abstract MsgBuffer putUnsignedShort(int index, short value);
    
    /**
     * Writes an unsigned Short into the ByteBuffer
     * @param value the int to write
     */
    public abstract MsgBuffer putUnsignedShort(int value);
     ...
     * @param value the int to write
     */
    public abstract MsgBuffer putUnsignedShort(int index, int value);
    
    /**
     * Writes an unsigned Short into the ByteBuffer
     * @param value the long to write
     */
    public abstract MsgBuffer putUnsignedShort(long value);
     ...
     * @param value the long to write
     */
    public abstract MsgBuffer putUnsignedShort(int index, long value);
     ...
     */
    public abstract MsgBuffer putInt(int index, int value);
     ...
     */
    public abstract MsgBuffer putLong(long value);
     ...
     * @see ByteBuffer#putLong(int, long)
     */
    public abstract MsgBuffer putLong(int index, long value);
     ...
     */
    public abstract MsgBuffer putFloat(float value);
     ...
     */
    public abstract MsgBuffer putFloat(int index, float value);
     ...
     */
    public abstract MsgBuffer putDouble(double value);
     ...
     */
    public abstract MsgBuffer putDouble(int index, double value);
     ...
     */
    public abstract MsgBuffer putString(CharSequence val, CharsetEncoder encoder) throws CharacterCodingException;
     ...
     */
    public abstract MsgBuffer putString(CharSequence val, int fieldSize, CharsetEncoder encoder) throws CharacterCodingException;
     ...
     *             if the specified string doesn't fit
     */
    public abstract MsgBuffer putPrefixedString(CharSequence in, CharsetEncoder encoder) throws CharacterCodingException;
     ...
     *             if the specified string doesn't fit
     */
    public abstract MsgBuffer putPrefixedString(CharSequence in, int prefixLength, CharsetEncoder encoder)
     ...
     *             if the specified string doesn't fit
     */
    public abstract MsgBuffer putPrefixedString(CharSequence in, int prefixLength, int padding, CharsetEncoder encoder)
            throws CharacterCodingException;
     ...
     *             if the specified string doesn't fit
     */
    public abstract MsgBuffer putPrefixedString(CharSequence val, int prefixLength, int padding, byte padValue,
     ...
     */
    public abstract MsgBuffer putObject(Object o);
     ...
     */
    public abstract MsgBuffer putEnum(Enum<?> e);
     ...
     *            The enum to write to the buffer
     */
    public abstract MsgBuffer putEnum(int index, Enum<?> e);
     ...
     *            The enum to write to the buffer
     */
    public abstract MsgBuffer putEnumShort(Enum<?> e);
     ...
     *            The enum to write to the buffer
     */
    public abstract MsgBuffer putEnumShort(int index, Enum<?> e);
     ...
     *            The enum to write to the buffer
     */
    public abstract MsgBuffer putEnumInt(Enum<?> e);
     ...
     *            The enum to write to the buffer
     */
    public abstract MsgBuffer putEnumInt(int index, Enum<?> e);
     ...
     */
    public abstract <E extends Enum<E>> MsgBuffer putEnumSet(Set<E> set);
     ...
     *            the enum set to write to the buffer
     */
    public abstract <E extends Enum<E>> MsgBuffer putEnumSet(int index, Set<E> set);
     ...
     *            the enum set to write to the buffer
     */
    public abstract <E extends Enum<E>> MsgBuffer putEnumSetShort(Set<E> set);
     ...
     *            the enum set to write to the buffer
     */
    public abstract <E extends Enum<E>> MsgBuffer putEnumSetShort(int index, Set<E> set);
     ...
     *            the enum set to write to the buffer
     */
    public abstract <E extends Enum<E>> MsgBuffer putEnumSetInt(Set<E> set);
     ...
     *            the enum set to write to the buffer
     */
    public abstract <E extends Enum<E>> MsgBuffer putEnumSetInt(int index, Set<E> set);
     ...
     *            the enum set to write to the buffer
     */
    public abstract <E extends Enum<E>> MsgBuffer putEnumSetLong(Set<E> set);
     ...
     *            the enum set to write to the buffer
     */
    public abstract <E extends Enum<E>> MsgBuffer putEnumSetLong(int index, Set<E> set);
}
